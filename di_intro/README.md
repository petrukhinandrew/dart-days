...
Поэтому будем делать мотоцыпл и Flutter использовать тут не будем, нас будет интересовать модель. Попробуем использовать как можно больше фичей injectable. Заодно что-нибудь потестируем
